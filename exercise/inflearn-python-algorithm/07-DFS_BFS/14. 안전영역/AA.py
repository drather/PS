...
def dfs(_r, _c, rain):
    ...
    for m in range(4):
        ...
        if 0 <= new_row < length and 0 <= new_col < length and check[new_row][new_col] == 0 and board[new_row][new_col] > rain:
            # print("\t\t새 위치: ", (new_row, new_col), r)
            dfs(new_row, new_col, rain)
    ...
    for r in range(0, max_h):
        ...
        for row in range(length):
            for col in range(length):
                if board[row][col] > r and check[row][col] == 0:
                    # print("\ncnt 추가 위치: ", (row, col), board[row][col])
                    cnt += 1
                    dfs(row, col, r)
...
#
#                             if 0 <= new_row < length and 0 <= new_col < length and check[new_row][new_col] == 0 and board[new_row][new_col] > r:
#                                 nw = (new_row, new_col)
#                                 queue.append(nw)
